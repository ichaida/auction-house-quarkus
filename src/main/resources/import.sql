...
INSERT INTO auctions(id, name, start_time, end_time, status, starting_price, current_price, house_id) VALUES (nextval('hibernate_sequence'), 'Nugat', make_timestamp(2020, 10, 25, 8, 15, 0), make_timestamp(2020, 10, 29, 10, 10, 0), 'RUNNING', 398.5, 506.5, 1);
...
INSERT INTO bids(id, bid_amount, auction_id, bidder_id) VALUES (1, 750, 2, 1)
